        ...
        <div class="container">
            ...
            <div class="timeline-wrapper">
                ...
                <div class="timeline-scroll-hint">
                    ...
                    <span>Slinkite horizontaliai</span>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="timeline-detail-card" id="timeline-detail-card">
                <div class="detail-card-inner">
                    <div class="detail-header">
                        <div class="detail-year-badge" id="detail-year-badge">2019</div>
                        <h3 class="detail-title" id="detail-title">Pradžia</h3>
                    </div>
                    <p class="detail-description" id="detail-description">Serverio idėjos gimimas ir pirmieji žingsniai</p>
                </div>
            </div>
